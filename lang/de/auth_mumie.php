...
$string['privacy:metadata:auth_mumie_servers:userid'] = 'Ein pseudonymer Identifikator des Nutzers';
$string['privacy:metadata:auth_mumie_servers:tableexplanation'] = 'Details zum pseudonymen Identifikator, der für das Single-Sign-On mit MUMIE/Lemon-Servern geteilt wird. Es werden keine personenbezogenen Daten (Name, E-Mail) geteilt.';
